...
export const layer5 = () => {
    const test: Cell[] = [
        ...
        { name: CellName.fire, location: [12,40], },
        { name: CellName.milk, location: [20,40], },
        { name: CellName.blank, location: [28,40], },
        { name: CellName.corn, location: [36,40], },
        { name: CellName.wool, location: [36,32], },
        { name: CellName.fire, location: [36,24], },
        { name: CellName.corn, location: [36,16], },
        { name: CellName.grass, location: [36,8], },
